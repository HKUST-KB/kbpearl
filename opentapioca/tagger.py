...
class Tagger(object):
    ...
    def tag_and_rank(self, phrase, prune=True):
        ...
        resp = r.json()
        #print('This is the content of request and response')
        #print(str(requests))
        #print(resp)
        ...
        #print('This is the mentions_json')
        #print(mentions_json)
        ...
        #print('This are the pruned mentions')
        #print(pruned_mentions)
